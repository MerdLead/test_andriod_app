...
class_data = (
    ...
    {'name': 'van在线教育12', 'count': '10', 'status': 'false'},
    {'name': 'v@在线$123', 'count': '8', 'status': 'true'},  # 特殊字符
    {'name': '2VANTHNKvan1ink以数字studeVANTH7INKr', 'count': '34', 'status': 'false'},   # 多于30个字符 - 34个
    {'name': '8VANTH7INK4v     nkstu在线', 'count': '20', 'status': 'false'},   # 24个字符  5个连续空格
    {'name': '180q azws123xQA ZWS XEDC19在线教育', 'count': '30', 'status': 'true'},  # 30个字符  空格
    {'name': 'block', 'count': '5', 'assert': '班级名 已存在'}  # 不可重名
)
