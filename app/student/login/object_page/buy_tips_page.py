...
class BuyTipsPage(BasePage):
    ...
    def tips_title(self):
        """以“标题” 的id"""
        ele = self.driver\
            .find_element_by_id("com.vanthink.student.debug:id/head_hint").text
        print(ele)
    ...
    def goto_pay_button(self):
        """去购买 按钮 """
        self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/goto_pay")\
            .click()
    ...
    def goto_verification(self):
        """购买 验证 """
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/goto_verification")
        return item
    ...
    def st_name(self):
        """学生name """
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/name").text
        print(item)
    ...
    def online_service(self):
        """在线客服"""
        self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/goToCustomerService").click()

    @teststeps
    def buy_hint(self):
        """购买 提示信息"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay_hint").text
        print(item)
    ...
    def hint_info(self):
        """提示信息"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/hint").text
        print(item)
    ...
    def check_button(self):
        """卡前的 单选框 """
        item = self.driver \
            .find_elements_by_id("com.vanthink.student.debug:id/check")
        return item
    ...
    def card_name(self):
        """卡的类型:月卡、季卡、半年卡、年卡 """
        item = self.driver \
            .find_elements_by_id("com.vanthink.student.debug:id/one")
        return item
    ...
    def card_price(self):
        """卡的 价格 """
        item = self.driver \
            .find_elements_by_id("com.vanthink.student.debug:id/two")
        return item
    ...
    def current_card(self):
        """目前选定的是X卡"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/current_vip_card_hint").text
        print('目前选中的卡为：', item)
    ...
    def buy_agreement(self):
        """购买协议"""
        self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay_agreement").click()

    @teststep
    def direct_buy_button(self):
        """直接购买"""
        ele = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay")
        return ele
    ...
    def discount_pbuy_button(self):
        """优惠购买"""
        ele = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/discount_pay")
        return ele
    ...
    def price_info(self):
        """价格"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/money").text
        return item
    ...
    def card_hint(self):
        """所购卡的 提示信息"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/vip_type_hint").text
        print(item)
    ...
    def wechat_pay_check(self):
        """微信 单选框 """
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/wechat_pay_check")
        return item
    ...
    def ali_pay_check(self):
        """支付宝 单选框 """
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/ali_pay_check")
        return item
    ...
    def parent_pay_check(self):
        """家长代付 单选框 """
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/parent_pay_check")
        return item
    ...
    def confirm_pay_button(self):
        """确认支付 按钮"""
        self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay").click()
    ...
    def card_type(self):
        """卡的类型"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/card_type").text
        print(item)
    ...
    def qr_code_hint(self):
        """wording：微信扫描二维码付款"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay_type_hint").text
        print(item)
    ...
    def qr_code_judge(self):
        ...
        try:
            self.driver \
                .find_element_by_id("com.vanthink.student.debug:id/qr_code")
            return True
        except Exception:
            return False
    ...
    def pay_finish_button(self):
        """支付完成 按钮"""
        self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay_complete").click()
    ...
    def pay_result_img_judge(self):
        ...
        try:
            self.driver \
                .find_element_by_id("com.vanthink.student.debug:id/pay_result_img")
            return True
        except Exception:
            return False
    ...
    def pay_result(self):
        """付款结果"""
        item = self.driver \
            .find_element_by_id("com.vanthink.student.debug:id/pay_result").text
        print(item)
